...
let [number, pesan] = text.split `|`
    ...
    if (!number) return conn.reply(m.chat, 'Penggunaan .menfess nomor|pesan untuknya\nContoh : .menfess 628xxxxxxxxxx|hai owner', m, {quoted: m, thumbnail: await (await fetch('https://telegra.ph/file/b9a32ee41970d7a71b476.jpg')).buffer(),
        contextInfo: { forwardingScore: 999, isForwarded: true, externalAdReply: {title: 'Gunakan Dengan Bijak Yah Kak', sourceUrl: 'http://wa.me/6289696764138?text=.chat 6289696764138|Hi Dimas Hehehe 🌹', body: 'DimzBot', thumbnail: await (await fetch('https://telegra.ph/file/345dfdd724db22d617ed3.jpg')).buffer(),}}})
